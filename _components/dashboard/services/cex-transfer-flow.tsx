...
export default function CexTransferFlow() {
    ...
    return (
      <div className="w-full max-w-md mx-auto p-4 space-y-6">
        ...
        <div className="text-center space-y-2">
          <h2 className="text-xl font-semibold text-white">Transfer to {selectedExchange.name}</h2>
          <p className="text-sm text-gray-400">Copy your UID to proceed</p>
        </div>
        ...
        <Card className="bg-gray-900 border-gray-800 p-6">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white">{selectedExchange.name}</h3>
              <p className="text-sm text-gray-400">Exchange Platform</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div>
              <label className="text-sm font-medium text-gray-300 mb-2 block">Your {selectedExchange.name} UID</label>
              <div className="flex items-center gap-2 p-4 bg-gray-800 rounded-lg border border-gray-700">
                <code className="flex-1 text-lg font-mono text-white">{selectedExchange.uid}</code>
                <Button
  ...
  return (
    <div className="w-full max-w-md mx-auto p-2 space-y-6">
      {/* Header */}
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-bold text-white">Select Exchange</h2>
        <p className="text-gray-400">Choose your preferred exchange platform</p>
      </div>
      ...
      <div className="relative">
        <Card className="dark:bg-card">
          ...
          >
            <span className="text-white font-medium">Select an exchange</span>
            <ChevronDown
            ...
            <div className="border-t border-gray-800">
              {exchanges.map((exchange) => (
                <button
                  ...
                  className="w-full p-4 flex items-center gap-4 hover:bg-gray-800 transition-colors border-b border-gray-800 last:border-b-0"
                >
                  <div
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-400">UID: {exchange.uid}</p>
                  </div>
                </button>
              ))}
            </div>
      ...
      <Card className="bg-gray-900 border-gray-800 p-4 space-y-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-gray-300 mb-1">How it works</p>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-gray-300 mb-1">Active Hours</p>
            <p className="text-sm text-gray-400">
              9am – 6pm <span className="text-gray-500">(transactions completed within max 30 mins)</span>
            </p>
