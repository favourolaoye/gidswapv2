...
import { FaTwitter, FaInstagram, FaDiscord, FaWhatsapp, FaTimes } from "react-icons/fa";
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-20 right-0 w-72 bg-white text-gray-900 rounded-2xl shadow-2xl p-6 dark:bg-blue-950/20 dark:text-gray-50"
          >
            ...
            <div className="space-y-4 text-sm ">
              ...
              <div className="flex items-center gap-3">
                ...
                <span>gidswap.co@gmail.com</span>
              </div>
              <div className="flex items-start gap-3">
                <MapPin className="w-4 h-4 text-gray-900 mt-1 dark:text-gray-50" />
                <span>
                 132 Awolowo Road, Ikoyi,<br />
                  Lagos, Nigeria
                </span>
              </div>
            </div>
