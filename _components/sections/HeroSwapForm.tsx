      ...
      <div className="relative rounded-[20px] bg-gray-100 p-3 dark:bg-white/5 backdrop-blur-sm">
        <div className="flex space-y-2 flex-col">
          ...
          <div className="flex space-y-2 flex-col relative">
            ...
            {/* Swap Arrow */}
            <div className="flex justify-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 -mt-2">
            ...
            <div className="flex flex-col space-y-2 rounded-xl bg-white px-3 py-2 dark:bg-neutral-900 shadow-sm">
              <label
                ...
                className="flex items-center justify-between text-gray-500 dark:text-white/50"
              >
                Receive
                <Select
                  onValueChange={(value: string) =>
                ...
                >
                  <SelectTrigger className="futuristic-button w-fit flex h-9 items-center gap-2 rounded-full p-2 border-[#0b5cb5] text-[#0b5cb5] hover:bg-[#0b5cb5]/10 dark:border-blue-400 dark:text-blue-400 dark:hover:bg-blue-400/10 hover:shadow-[0_0_6px_rgba(11,92,181,0.3)]">
                    <Image
