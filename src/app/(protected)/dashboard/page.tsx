...
type ServiceType = "crypto-crypto" | "crypto-fiat" | "fiat-crypto" | "cex-transfer" | null

const services = [
  {
    id: "crypto-crypto" as ServiceType,
    title: "Crypto to Crypto",
    description: "Swap between different cryptocurrencies instantly with competitive rates",
    icon: "🔄",
  ...
  },
  {
    ...
    description: "Convert your cryptocurrency to fiat currency and withdraw to your bank",
    icon: "💰",
  ...
  },
  {
    ...
    description: "Transfer funds between different cryptocurrency exchanges securely",
    icon: "🔀",
  ...
  const renderServiceSelection = () => (
    <div className="w-full max-w-6xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-400 text-lg">All your crypto moves in one place</p>
